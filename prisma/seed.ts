...
const aircraftData: Record<string, { registration: string; type: string; manufacturer: string }[]> = {
  KE: [
...
async function main() {
  ...
  const createdAirlines: Record<string, { id: string }> = {};
  ...
  console.log('시드 완료!');
  console.log('관리자 계정: admin@aviation.kr / admin1234');
}
